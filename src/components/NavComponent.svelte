...
<template>
  <nav data-testid="app-nav" class='App-nav' class:active='{nav}'>
    ...
    <div class="App-nav-content" on:click='{() => nav = false}'>
      <a href="/" class="App-nav-item" use:link>
        <svg fill="var(--main-color)" height="25px" viewBox="0 0 25 25" width="25px" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="/login" class="App-nav-item" use:link>
      ...
      <a href="/config" class="App-nav-item" use:link>
        <svg fill="var(--main-color)" height="25px" viewBox="0 0 25 25" width="25px" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 0h24v24H0z" fill="none"></path>
    ...
    <div class='overlay' class:active='{nav}' on:click='{() => nav = false}'></div>
  </nav>
</template>
